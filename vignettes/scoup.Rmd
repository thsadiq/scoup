---
title: "scoup: Simulate Codons with an OU Evolutionary Pattern"
author: Hassan Sadiq
output:
...
($\mathrm{d}N/\mathrm{d}S$) selection effects were compared.
...
# Number of codon sites
## Commented value was used for results presented in publication
sitesize<- 15 # 100
...
working directory.
```{bash, eval=FALSE}
hyphy fubar --code Universal --alignment seq.nex --tree seq.nex --output seq.json
```
