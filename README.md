...
## About
 <!-- badges: start -->
  [![DOI](https://zenodo.org/badge/DOI/10.18129/B9.bioc.scoup.svg)](https://www.bioconductor.org/packages/devel/bioc/html/scoup.html)
  <!-- badges: end -->
...
- [paper](paper): contains the files that are used to prepare the manuscript that describes the package for the Journal of Open Source Software. Similar files for other publications related to the package will be included herein as they become available.
